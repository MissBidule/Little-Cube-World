...
int main()
{
    ...
    ctx.update = [&]() {
        ...
        glUniform3fv(earth.uLightDir_vs, 1, glm::value_ptr(glm::vec3(glm::vec4(1, 1, 1, 0) * glm::rotate(glm::mat4(1.0f), ctx.time(), glm::vec3(0, 1, 0)) * ViewMatrix.getViewMatrix())));
        glUniform3fv(earth.uLightIntensity, 1, glm::value_ptr(glm::vec3(0.5, .5, .5)));
        ...
        for (int i = 0; i < 32; i++)
        {
            ...
            glUniform3fv(moon.uLightDir_vs, 1, glm::value_ptr(glm::vec3(glm::vec4(1, 1, 1, 0) * glm::rotate(glm::mat4(1.0f), ctx.time(), glm::vec3(0, 1, 0)) * ViewMatrix.getViewMatrix())));
            glUniform3fv(moon.uLightIntensity, 1, glm::value_ptr(glm::vec3(.5, .5, .5)));
